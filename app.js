...
app.get('/logout', function(req, res) {
  ...
  if(req.session.loggedIn == true){
    ...
    console.log('session set to inactive');
    if(req.session.loggedIn == true){
      console.log('session was not successfully killed.');
    }else{
      console.log('session was successfully killed.');
    }
  }
  res.send(200);
});
...
app.listen(3570);
console.log("Ugly Violin is listening to port 3570.");
